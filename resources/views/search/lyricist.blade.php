...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Lyricist</div>
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="{{route('search.lyricist')}}" class="form-inline my-2 my-lg-0">
                    ...
                    <tbody>
                        ...
                        <td><a href="{{ route('search.lyricistshow',['id' => $contact->id]) }}">詳細を見る</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                    </table>
